...
from abkit.metrics import init_statsd
...
from abkit.models import Experiment, Client
from abkit.utils import service_unavailable_on_connection_error, json_error, json_success
    ...
    def on_home(self, request):
        dales = """
            ...
            (|`-_-',.`-_-',.`-_-'/  |
             ...
             |     ||     ||     |
              `-_-'  `-_-'  `-_-'
        https://github.com/leepand/algolink"""
